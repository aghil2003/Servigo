...
//   const x1 = useTransform(scrollYProgress, [0, 1], [0, 140]); 
//   const y1 = useTransform(scrollYProgress, [0, 1], [0, 570]);
//   const rotate1 = useTransform(scrollYProgress, [0, 1], [-12, 1]);
//   const scale1 = useTransform(scrollYProgress, [0, 1], [1, 0.95]);

//   const x2 = useTransform(scrollYProgress, [0, 1], [0, -110]);
//   const y2 = useTransform(scrollYProgress, [0, 1], [0, 670]);
//   const rotate2 = useTransform(scrollYProgress, [0, 1], [10, -1]);
//   const scale2 = useTransform(scrollYProgress, [0, 1], [1, 0.96]);

//   const x3 = useTransform(scrollYProgress, [0, 1], [0, -120]); 
//   const y3 = useTransform(scrollYProgress, [0, 1], [0, 530]); 
//   const scale3 = useTransform(scrollYProgress, [0, 1], [1, 0.97]);
...
//         <div className="absolute top-[90px] ml-[360px] rounded-lg z-0">
...
//           <div className="text-[50px] font-medium z-0">
//           SERVIGO
//           </div>
...
//         fill // Replaces layout="fill" in latest Next.js versions
//         className="object-cover object-top  pointer-events-none opacity-10"
//       />
//     </div>
   

//     {/* Foreground images and content */}
...
//       <p className="text-[18px] font-poppins font-bold text-left break-words leading-tight">Cousult With Our </p>
//       <p className="ml-[35px] text-[18px] font-poppins font-bold text-left break-words leading-tight">Team -></p>
//     </div>
     
//     <div className="absolute top-[310px] left-[10px]">
//   <div className="text-[40px] font-medium leading-tight z-0 font-bebas">
//     SERVIGO
//   </div>
...
//     {/* Optional extra divs */}
//     <div className="img1 bg-white rounded shadow-md z-10"></div>
//     <div className="img2 bg-white rounded shadow-md z-10"></div>
//     <div className="img3 bg-white rounded shadow-md z-10"></div>
//   </div>
// </div>
...
export function Bannercontainer() {
  ...
  const y3 = useTransform(scrollYProgress, [0, 0.3], [0, 470], { clamp: true });
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-[90px] ml-[320px] rounded-lg z-0">
          <h1 className="text-[48px] ml-[70px] font-poppins font-bold leading-tight text-gray-800">"Book with Ease.</h1>
          <h1 className="text-[48px] ml-[10px] font-poppins font-bold leading-tight text-gray-800">Relax with confidence."</h1>
          <div className="">
            <div className="text-[32px] font-bebas font-semibold text-blue-700 mt-2 mb-2 ml-[190px]">SERVIGO</div>
