...
//       if (!service || !selectedLocation?.[0] || !selectedLocation?.[1]) {
//         return;
//       }
...
//           console.log("Selected Location set to:", coords);
//         },
//         (error) => {
...
//               Expert{" "}
//               <span className="font-semibold text-indigo-700 ml-1">{service}</span>{" "}
//               near you
//             </div>
//           </div>
//         </div>
...
//               <Input type="text" placeholder="Search by name" className="text-sm w-full" />
//               <Select defaultValue="rating" onValueChange={(value) => setSortOption(value)}>
...
//               <Button className="bg-indigo-500 text-xs px-3 text-white w-full sm:w-auto">
...
//                   onChange={(e) => setSearchTerm(e.target.value)}
//                 />
//                 <Button className="text-sm" onClick={() => fetchWorkers(1)}>
//                   Search
//                 </Button>
//               </div>
...
//                   className={`bg-gray-100 px-4 py-1 ${page === 1 ? "opacity-50 cursor-not-allowed" : ""}`}
//                 >
//                   Previous
//                 </Button>
...
//                   onClick={() => fetchWorkers(page + 1)}
//                   className={`bg-gray-100 px-4 py-1 ${page === totalPages ? "opacity-50 cursor-not-allowed" : ""}`}
//                 >
//                   Next
//                 </Button>
//               </div>
